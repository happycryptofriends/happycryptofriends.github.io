<template>
  ...
  >
    ...
    <p>
      And we put it all out on <strong>GitHub</strong>* to be transparent, unlike those scumbags.
    </p>
    <p class="is-small">
      * For those of you who are not software devs, this means other software devs can hop in and look into the code and check&nbsp;it.<br>
